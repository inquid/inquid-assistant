...
function machineLearning(){
  ...
  var response = '';
  console.log(val);
  if(val.includes('factura')){
    response = 'Muy bien vamos al módulo de facturación';
    console.log(val);
    adminSend(response);
    window.location = "http://localhost/servisum/web/facturacion/default/index";
    return true;
  }
  else{
    response = 'No entendí lo que dijiste';
    console.log(val);
    adminSend(response);
  }
}
